...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <p>
                Manage your company information and help job seekers
            ...
            <form action="companyProfile" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea
                        ...
                        name="companyProfile.companyDescription"
                        rows="6"
                        placeholder="Tell job seekers about your company"><s:property value="companyProfile.companyDescription"/></textarea>
