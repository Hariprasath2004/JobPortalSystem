    ...
    <div class="container">
                ...
                <div class="application-card">
                    ...
                    <div class="application-status">
                        ...
                        <s:if test="applicationStatus != null">
                            ...
                            <s:elseif test="applicationStatus.equalsIgnoreCase('SHORTLISTED')">
                            ...
                            <s:else>
                                ...
                                <span class="status default-status">
        ...
        <s:else>
            ...
            <div class="empty-state">
                ...
                <a href="jobSearch" class="btn btn-primary">
                    Search Jobs
                </a>
        ...
        <div class="page-actions">
            ...
            <a href="seekerDashboard" class="btn btn-secondary">
                Back to Dashboard
            </a>
